...
def main( ):
    ...
    if  "1" == args.model_name[ 0 ] and "2D" in args.model_name:
        ...
        # =================================================================================================== #
        # [Target 1] [Optimal value] [0.05071] [idx] [232]
        # [Target 1] [Optimal input pars] [-1.50098, 0.     ,-0.2715 , 1.41372, 1.72788, 0.     , 0.     , 0.36652, 0.95   ] [cam_pos] [0.55578,  0.01402, -0.57997,  5.16944,-14.29162, 98.39433]
        # [Target 2] [Optimal value] [0.05935] [idx] [256]
        # [Target 2] [Optimal input pars] [-1.0821 , 1.0472 , 1.0472 , 0.7854 , 1.72788,-1.0472 , 1.39626, 0.12217, 0.95   ] [cam_pos] [0.24485,  0.38412, -1.22991,  6.25152,-45.53129,147.48524]
        # [Target 3] [Optimal value] [0.13481] [idx] [238]
        # [Target 3] [Optimal input pars] [-0.94248, 1.0472 , 0.34907, 1.09956, 1.72788,-1.0472 ,-0.23271, 1.06465, 0.58333] [cam_pos] [0.00263,   0.28365,  -0.44388,   6.82415, -25.87367,-173.73081]
