...
python3 -B main_whip_sensitivity.py --vid_off --target_idx 1 --start_time 0.1 --run_time 2.5
python3 -B main_whip_sensitivity.py --vid_off --target_idx 2 --start_time 0.1 --run_time 2.5
python3 -B main_whip_sensitivity.py --vid_off --target_idx 3 --start_time 0.1 --run_time 2.5
python3 -B main_whip_sensitivity.py --vid_off --target_idx 4 --start_time 0.1 --run_time 2.5
python3 -B main_whip_sensitivity.py --vid_off --target_idx 5 --start_time 0.1 --run_time 2.5
